...
::: {.column-margin}
Non abbiamo verificato se questo filtro sia ad oggi coerente con quanto pubblicato.
:::
...
Allora giorno 8 luglio 2023 abbiamo creato uno *script* che li estrae ogni giorno automaticamente e li pubblica automaticamente su [questo *repository* GitHub](https://github.com/ondata/ondate-calore).<br>
